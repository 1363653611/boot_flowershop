        ...
        <div class="container_12">
			...
			<div id="wrapper_tab" class="tab1">
			    ...
			    <div class="tab1 tab_body">
					<table>
				      <tr class="bg">
					   <th>订单编号</th><th>总价(￥)</th><th>创建时间</th><th>收货信息</th><th>收货方式</th><th>付款状态</th><th>发货状态</th><th style="width: 100px;">操作</th>
				      </tr>
				     <c:forEach items="${fklist}" var="fkorder">
					  <tr>
						 ...
						 <font style="font-weight: bold;">地址:&nbsp;&nbsp;</font>${fkorder.address.name}&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-weight: bold;">${fkorder.address.addr}&nbsp;&nbsp;&nbsp;&nbsp;${fkorder.address.tel}</font>
						  ...
						  <td>
						  <c:if test="${fkorder.fkstatus eq '待付款' and fkorder.shfs eq '自取'}">
				     ...
				     <c:forEach items="${shlist}" var="shorder">
					  <tr>
						 ...
						 <font style="font-weight: bold;">地址:&nbsp;&nbsp;</font>${shorder.address.name}&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-weight: bold;">${shorder.address.addr}&nbsp;&nbsp;&nbsp;&nbsp;${shorder.address.tel}</font>
						  ...
						  <a href="javascript:void(0)" onclick="ordershouhuo('${shorder.id}')" style="text-decoration: none;font-family: '楷体';color:#6F8921;font-weight: bold;">确认收货</a>
						  </td>
					  </tr>
					  </c:forEach>
					</table>
				...
				<table>
						<tr class="bg">
					   <th>订单编号</th><th>总价(￥)</th><th>创建时间</th><th>收货信息</th><th>收货方式</th><th>操作</th>
				      </tr>
				     <c:forEach items="${wclist}" var="wcorder">
					  <tr>
						 ...
						 <font style="font-weight: bold;">地址:&nbsp;&nbsp;</font>${wcorder.address.name}&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-weight: bold;">${wcorder.address.addr}&nbsp;&nbsp;&nbsp;&nbsp;${wcorder.address.tel}</font>
						  ...
						  <c:if test="${wcorder.shstatus eq '已收货' }">
						  <a href="javascript:void(0)"  style="text-decoration: none;font-family: '楷体';color:#6F8921;font-weight: bold;">交易完成</a>
						  </c:if>
						  
						  <c:if test="${wcorder.shfs eq '送货上门' }">
						  <a href="javascript:void(0)" onclick="checkWl('${wcorder.orderno}')" style="text-decoration: none;font-family: '楷体';color:#6F8921;font-weight: bold;">查看物流信息</a>
						  </c:if>
