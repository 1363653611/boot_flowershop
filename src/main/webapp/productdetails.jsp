        ...
        <div class="container_12">
			...
			<div class="entry_content">
				...
				<div class="availability_sku">
					...
					点赞: ${product.vote}<a href="javascript:void(0)" onclick="toupiao('${product.id}')"><img alt="" src="/images/toupiao.jpg" style="width: 30px;height: 30px;"></a> 
				    </div>
				    
				    <c:forEach items="${svlist}" var="servicer">
				    <div class="availability">
					${servicer.name}: <font style="color:#6F8921"></font>
				    </div>
				    </c:forEach>
